...
#define ACC_PWR_CONF_MODE_SUSPENDED     0x03
#define ACC_PWR_CONF_MODE_ACTIVE        0x00
#define ACC_PWR_CTRL_ACCEL_OFF          0x00
#define ACC_PWR_CTRL_ACCEL_ON           0x04
#define ACC_SOFTRESET_RESET_VAL         0xB6

//Gyro Status Code
#define GYRO_CHIP_ID_VALUE              0x0F
#define GYRO_INT_STAT_1_DRDY_MASK       0b10000000
#define GYRO_INT_STAT_1_FIFO_MASK       0b00010000
#define GYRO_FIFO_STATUS_FIFO_OVERRUN   0b10000000
#define GYROBWP_OSR4                    0x08
#define GYROBWP_OSR2                    0x09
#define GYROBWP_NORMAL                  0x0A
#define GYROODR_12H5                    0x05
#define GYROODR_25HZ                    0x06
#define GYROODR_50HZ                    0x07
#define GYROODR_100HZ                   0x08
#define GYROODR_200HZ                   0x09
#define GYROODR_400HZ                   0x0A
#define GYROODR_800HZ                   0x0B
#define GYROODR_1600HZ                  0x0C
#define GYRORANGE_3G                    0x00
#define GYRORANGE_6G                    0x01
#define GYRORANGE_12G                   0x02
#define GYRORANGE_24G                   0x04
#define GYRO_CONFIG_0_MODE_STREAM       0x00
#define GYRO_CONFIG_0_MODE_FIFO         0x01
#define GYRO_CONFIG_1_ACC_ENABLE        0b01000000
#define GYRO_CONFIG_1_INT1_EN           0b00001000
#define GYRO_CONFIG_1_INT2_EN           0b00000100
#define GYRO_IO_CONF_INT1_IN            0b00010000
#define GYRO_IO_CONF_INT1_OUT           0b00001000
#define GYRO_IO_CONF_INT1_OD            0b00000100
#define GYRO_IO_CONF_INT1_LVL           0b00000010
#define GYRO_IO_CONF_INT2_IN            0b00010000
#define GYRO_IO_CONF_INT2_OUT           0b00001000
#define GYRO_IO_CONF_INT2_OD            0b00000100
#define GYRO_IO_CONF_INT2_LVL           0b00000010
#define GYRO_INT2_MAP_DATA_INT2_DRDY    0b01000000
#define GYRO_INT2_MAP_DATA_INT2_FWM     0b00100000
#define GYRO_INT2_MAP_DATA_INT2_FFULL   0b00010000
#define GYRO_INT2_MAP_DATA_INT1_DRDY    0b00000100
#define GYRO_INT2_MAP_DATA_INT1_FWM     0b00000010
#define GYRO_INT2_MAP_DATA_INT1_FFULL   0b00000001
#define GYROSELF_TEST_OFF               0x00
#define GYROSELF_TEST_POSITIVE          0x0D
#define GYROSELF_TEST_NEGATIVE          0x09
#define GYROPWR_CONF_MODE_SUSPENDED     0x03
#define GYROPWR_CONF_MODE_ACTIVE        0x00
#define GYROPWR_CTRL_ACCEL_OFF          0x00
#define GYROPWR_CTRL_ACCEL_ON           0x04
#define GYROSOFTRESET_RESET_VAL         0xB6
